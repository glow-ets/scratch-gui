/**
 * scratch3_webmidi/index.js
 * Extracted from: https://uchiwafuujinn.github.io/scratch3webmidi/ (gh-pages branch, 2025)
 * Original author: UchiwaFuujinn
 * License: BSD-3-Clause
 *
 * Differences vs webmidi-extension .mjs (4 years old):
 *   - Added mNoteOff[] array for per-note key-off tracking
 *   - Added s_Getkeyoffnum() block (KEY OFF [note])
 *   - Extension ID is 'webmidi' (not 'WebMidiExtension')
 *   - Default value for KEY ON [ckeynum] is 48 (not 1)
 *   - Uses native ES6 class syntax (not Babel-transpiled)
 *   - References scratch-vm's own ArgumentType, BlockType, Cast, log, formatMessage, MathUtil, Timer
 */

const formatMessage = __webpack_require__(/*! format-message */ "../scratch-vm/node_modules/format-message/index.js");
